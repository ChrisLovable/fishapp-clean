-- Create public_gallery table for shared catch photos
-- This table stores catch photos that are visible to all users

-- Create the public_gallery table
CREATE TABLE IF NOT EXISTS public_gallery (
  ...
  user_id text NOT NULL, -- Track who uploaded (for deletion rights)
